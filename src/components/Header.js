...
const Header = () => {
  return (
    <header className="bg-gradient-to-r from-green-500 to-green-600 text-white p-2 shadow-md">
      <div className="container mx-auto flex flex-col items-center xs:flex-row xs:justify-between">
        {/* Título "Cocina Casera" con un icono de Heroicons */}
        <h1 className="text-base xs:text-lg sm:text-xl font-bold mb-1 xs:mb-0 flex items-center">
          Cocina Casera
          <HomeIcon className="h-4 w-4 xs:h-5 xs:w-5 ml-2" aria-hidden="true" />
        </h1>
        ...
        >
          <span className="mr-1">Hablar por WhatsApp</span>
          <svg
